...
export default function ImageArray({ time }) {
 ...
 useEffect(() => {
  ...
  return (
    <>
      <img   ref={init_ref(0)} src={image1.src} width="100%" style={{ display: 'block' }} />
      <img   ref={init_ref(1)} src={image2.src} width="100%" style={{ display: 'none' }} />
      <img   ref={init_ref(2)} src={image3.src} width="100%" style={{ display: 'none' }} />
    </>
  );
}
