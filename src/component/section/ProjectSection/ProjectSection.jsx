...
export default function ProjectSection() {
  ...
  return (
    <section style={{ height: "100vh", width: "100vw" }} id="project">
      <div className="section_title">(03) PROJECTS</div>
      <div className="project_container">
        <div
          ref={projects_ref}
          className="project"
          style={{ borderTop: "2px solid var(--color-shade5)" }}
          onClick={() =>
            openLink("https://github.com/Rajnish8292/dining_table_configurator")
          }
        >
        ...
        <div
          ref={projects_ref}
          className="project"
          onClick={() => openLink("https://github.com/Rajnish8292/mustang")}
        >
        ...
        <div
          ref={projects_ref}
          className="project"
          onClick={() => openLink("https://github.com/Rajnish8292/active-hop")}
        >
          <div className="project_wrapper">ACTIVE HOP (REBUILD)</div>
          <div className="bg_wrapper">
            <div className="top_slide"></div>
            <div className="bottom_slide"></div>
          </div>
        ...
        <div
          ...
          onClick={() =>
            openLink(
              "https://github.com/Rajnish8292/search_algorithm_visulazier"
            )
          }
        >
